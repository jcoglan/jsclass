JS.ENV.HashSpec = JS.Test.describe(JS.Hash, function() {
  ...
  sharedBehavior("hashtable", function() {
    ...
    describe("with object keys", function() {
      ...
      describe("#remove", function() {
        ...
        it("does not corrupt the rest of the hash", function() {
          hash.remove(new Car('ferari'))
  ...
  describe("OrderedHash", function() {
    ...
    describe("ordering", function() {
      ...
      it("keeps its keys in insertion order", function() {
        assertEqual( $w('red blue RED'), map(hash.keys(), 'code') )
      })
      
      it("keeps its values in insertion order", function() {
